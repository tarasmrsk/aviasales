  ...
  useEffect(() => {
    const fetchTicketsData = async () => {
      try {
        ...
        const ticketsResponse = await fetch(`https://aviasales-test-api.kata.academy/tickets?searchId=${searchData.searchId}`)
  ...
  return (
    <div>
      {tickets.map((ticket, index) => (
        ...
        <section key={index} className={classes.ticket}>
